local API = {}
local API_URL = "https://raw.githubusercontent.com/1337-svg/Liquid_Mix_Terminal/index_client/translator/api.json"

function FetchAPI()
	local successGetAsync, data = pcall(function()
		return game:GetService("HttpService"):GetAsync(API_URL, true, nil)
	end)
